                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group <?php echo e($errors->first('k_name') ? 'has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($keyword->k_name); ?>" name="k_name"  placeholder="Tên...">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea class="form-control" name="k_description" placeholder="Mô tả..."><?php echo e($keyword->k_description); ?></textarea>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/admin/keyword/update.blade.php ENDPATH**/ ?>