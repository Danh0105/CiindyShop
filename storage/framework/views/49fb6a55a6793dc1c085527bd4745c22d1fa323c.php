<form role="form" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="col-sm-12">
        <div class="box-footer text-center">
            ...
            <button type="submit" class="btn btn-success" name="submit" value="<?php echo e(isset($discount) ? 'update' : 'create'); ?>">Lưu   <i class="fa fa-save"></i></button>
        </div>
    </div>
</form><?php /**PATH C:\xampp\htdocs\THE CIINDYS\resources\views/admin/discount_code/form.blade.php ENDPATH**/ ?>