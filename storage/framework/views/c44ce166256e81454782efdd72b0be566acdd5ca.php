...
<?php $__env->startSection("content"); ?>
	<div class="container">
		<div class="breadcrumb">
			<ul>
				<li>
					<a href="/" title="Home" itemprop="url"><span itemprop="title">Trang chủ</span></a>
				</li>
				<li>
					<a href="<?php echo e(route("get.product.list")); ?>" title="Sản phẩm" itemprop="url"><span itemprop="title">Sản phẩm</span></a>
				</li>

				<li>
					<a href="<?php echo e(route("get.category.list", $product->category->c_slug . "-" . $product->category->id)); ?>"
						title="<?php echo e(isset($product->category) ? $product->category->c_name : ""); ?>" itemprop="url"><span
							itemprop="title"><?php echo e(isset($product->category) ? $product->category->c_name : ""); ?></span></a>
				</li>
		...
		<div class="card">
			<div class="card-body info-detail">
				<div class="left">
					...
					<a class="" href="<?php echo e(route("get.product.detail", $product->pro_slug . "-" . $product->id)); ?>" title="">
						<img class="lazyload" src="<?php echo e(pare_url_file($product->pro_avatar)); ?>" alt="" style="max-width: 100%">
					</a>
				</div>
				<div class="right" id="product-detail" data-id="<?php echo e($product->id); ?>">
					...
					<div class="right__content">
						<div class="info">
							...
							<div class="prices">
								<?php if($product->pro_sale): ?>
									...
									?>
									<p>
										Giá bán: <span class="value price-new"><?php echo e(number_format($price, 0, ",", ".")); ?> đ</span>
								...
								<p>
									<span>Tồn kho :&nbsp</span>
									<span><?php echo e($product->pro_number); ?></span>
								</p>
							</div>
							<?php if($product->attributes->count() > 0): ?>
								<div>
									...
									<div>
										...
										<div>
											<select class="form-control" id="product-color" name="color">
							...
							<div class="btn-cart">
								<a class="muangay" href="<?php echo e(route("get.shopping.add", $product->id)); ?>" title="">
									<span> THÊM VÀO GIỎ HÀNG </span>
								</a>
								<a class="muatragop <?php echo e(!\Auth::id() ? "js-show-login" : "js-add-favourite"); ?>"
									href="<?php echo e(route("ajax_get.user.add_favourite", $product->id)); ?>" title="Thêm sản phẩm yêu thích">
									<span> YÊU THÍCH </span>
								</a>
							</div></br>
							<div class="infomation">
								...
								<div class="infomation__group">
									...
									<div class="item">
										...
										<h3 class="text2">
											<?php if(isset($product->category->c_name)): ?>
												<a
													href="<?php echo e(route("get.category.list", $product->category->c_slug) . "-" . $product->pro_category_id); ?>"><?php echo e($product->category->c_name); ?></a>
											<?php else: ?>
												"[N\A]"
											<?php endif; ?>
										</h3>
									...
									<div class="item">
										...
										<h3 class="text2">
											<?php echo e(isset($product->producer) && !empty($product->producer) ? $product->producer->pdr_name : ""); ?></h3>
									</div>
								</div>
							</div>
						...
						<div class="ads">
							<a href="#" title="Giam giá" target="_blank"><img src="<?php echo e(url("images/banner/banner_01.jpg")); ?>"
									alt="Hoan tien" style="width: 100%"></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="comments">
				<div class="form-comment">
					<form action="" method="POST">
						<input name="productId" type="hidden" value="<?php echo e($product->id); ?>">
						<div class="form-group">
							<textarea class="form-control" id="" name="comment" placeholder="Nhập bình luận... " cols="30"
							 rows="5"></textarea>
						</div>
						<div class="footer">
							<p>
		...
		<div class="card-body product-des">
			...
			<div class="right">
				<a href="#" title="Giam giá" target="_blank">
					<img src="<?php echo e(url("images/banner/banner_02.png")); ?>" alt="Hoan tien" style="width: 100%">
				</a>
			</div>
		</div>
	</div>
	...
	<script>
		$(function() {
			$('.muangay').click(function(event) {
				...
				var gender = $('input[name=gender]:checked').val() !== undefined ? $(
...
<?php echo $__env->make("layouts.app_master_frontend", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/frontend/pages/product_detail/index.blade.php ENDPATH**/ ?>