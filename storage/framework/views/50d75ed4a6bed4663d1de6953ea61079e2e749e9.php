                                    ...
                                    <?php $__currentLoopData = $articles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('admin.article.hot', $article->id)); ?>" class="label label-default">Không có</a>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($article->a_active == 1): ?>
                                                    <a href="<?php echo e(route('admin.article.active', $article->id)); ?>" class="label label-info">Kích hoạt </a>
                                                <?php else: ?>
                                                    <a href="<?php echo e(route('admin.article.active', $article->id)); ?>" class="label label-default">Ẩn</a>
                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($article->created_at); ?></td>
                                            <td style="width: 120px">
                                                <a href="<?php echo e(route('admin.article.update', $article->id)); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i>Chỉnh sửa</a>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\THE CIINDYS\resources\views/admin/article/index.blade.php ENDPATH**/ ?>