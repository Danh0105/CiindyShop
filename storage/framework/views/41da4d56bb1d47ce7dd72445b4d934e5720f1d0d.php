...
<html>
	...
	<head>
		...
		<!-- Font Awesome -->
		<link href="<?php echo e(asset("admin/bower_components/font-awesome/css/font-awesome.min.css")); ?>" rel="stylesheet">
		<!-- Ionicons -->
		<link href="<?php echo e(asset("admin/bower_components/Ionicons/css/ionicons.min.css")); ?>" rel="stylesheet">
		<!-- Theme style -->
		<link href="<?php echo e(asset("admin/dist/css/AdminLTE.min.css")); ?>" rel="stylesheet">
		<!-- AdminLTE Skins. Choose a skin from the css/skins
												folder instead of downloading all of them to reduce the load. -->
		<link href="<?php echo e(asset("admin/dist/css/skins/_all-skins.min.css")); ?>" rel="stylesheet">
		<!-- Pace style -->
		<link href="<?php echo e(asset("admin/plugins/pace/pace.min.css")); ?>" rel="stylesheet">
		<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
		<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->

		<link href="<?php echo e(asset("admin/bower_components/select2/dist/css/select2.min.css")); ?>" rel="stylesheet">
	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="wrapper">
			<header class="main-header">
				<!-- Logo -->
				<a class="logo" href="<?php echo e(route("get.admin.index")); ?>">
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<a class="btn btn-default btn-flat" href="<?php echo e(route("admin.profile.index")); ?>">Thông tin</a>
										</div>

										<div class="pull-right">
											<a class="btn btn-default btn-flat" href="<?php echo e(route("get.logout.admin")); ?>">Đăng xuất</a>
										</div>
									</li>
								</ul>
							</li>
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu" data-widget="tree">
						...
						<?php $__currentLoopData = config("sidebar"); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<?php endif; ?>
							<li
								class="<?php echo e(isset($item["sub"]) ? "treeview" : ""); ?> <?php echo e(in_array(Request::segment(2), $item["list-check"]) ? " active menu-open" : ""); ?>">
						...
						<li><a href="<?php echo e(route("admin.event.index")); ?>"><i class="fa fa-calendar" aria-hidden="true"></i><span>Quản lý sự
									kiện</span></a></li>
						<li><a href="<?php echo e(route("admin.slide.index")); ?>"><i class="fa fa-calendar-minus-o"
									aria-hidden="true"></i><span>Quản lý banner</span></a></li>
						<li><a href="<?php echo e(route("admin.static.index")); ?>"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>
...
<?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/layouts/app_master_admin.blade.php ENDPATH**/ ?>