<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1>Quản lý danh mục Khuyến mãi</h1>
        <ol class="breadcrumb">
                                ...
                                <?php if($discountCodes): ?>
                                    <?php $__currentLoopData = $discountCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $discount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo e(route('admin.discount.code.update', $discount->id)); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i> Chỉnh sửa</a>
                                                <a href="<?php echo e(route('admin.discount.code.delete', $discount->id)); ?>" class="btn btn-xs btn-danger js-delete-confirm"><i class="fa fa-trash"></i>Xóa</a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\THE CIINDYS\resources\views/admin/discount_code/index.blade.php ENDPATH**/ ?>