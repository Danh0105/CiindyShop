                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group <?php echo e($errors->first('sd_title') ? 'has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($slide->sd_title); ?>" name="sd_title"  placeholder="Tên banner...">
                        ...
                        <div class="col-sm-8">
                            <div class="form-group <?php echo e($errors->first('sd_link') ? 'has-error' : ''); ?>">
                                ...
                                <input type="text" class="form-control" name="sd_link" value="<?php echo e($slide->sd_link); ?>"  placeholder="Sao chép đường link sản phẩm...">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="sd_sort" value="<?php echo e($slide->sd_sort); ?>" placeholder="Vị trí banner...">
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/admin/slide/update.blade.php ENDPATH**/ ?>