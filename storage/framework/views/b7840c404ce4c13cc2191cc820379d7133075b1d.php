                ...
                <div class="box-body">
                    <form role="form" action="" method="POST">
                        ...
                        <div class="form-group <?php echo e($errors->first('pdr_name') ? 'has-error' : ''); ?>">
                            ...
                            <input type="text" class="form-control" value="<?php echo e(old('pdr_name')); ?>" name="pdr_name"  placeholder="Tên...">
                        ...
                        <div class="form-group <?php echo e($errors->first('pdr_phone') ? 'has-error' : ''); ?>">
                            ...
                            <input type="text" class="form-control" value="<?php echo e(old('pdr_phone')); ?>" name="pdr_phone"  placeholder="Số điện thoại...">
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\THE CIINDYS\resources\views/admin/producer/create.blade.php ENDPATH**/ ?>