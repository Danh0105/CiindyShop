			...
			<div class="box-header with-border">
				<div class="box-title">
					<form class="form-inline">
						...
						<input class="form-control" name="email" type="text" value="<?php echo e(Request::get("email")); ?>"
							placeholder="Email ...">
										...
										<tr>
											...
											<td>
												<div style="margin-bottom: 5px;">
													<a class="btn btn-xs btn-info js-preview-transaction" data-id="<?php echo e($transaction->id); ?>"
														href="<?php echo e(route("ajax.admin.transaction.detail", $transaction->id)); ?>"><i class="fa fa-eye"></i> Hiển
														thị</a>
													<a class="btn btn-danger btn-xs" name="export" type="submit"
														href="<?php echo e(route("downloadPDF", ["id" => $transaction->id])); ?>" target="_blank">
														<i class="fa fa-save"></i> In hóa đơn
													</a>
												</div>
												<div class="btn-group">

													<button class="btn btn-success btn-xs" type="button">Tình trạng</button>
													<button class="btn btn-success btn-xs dropdown-toggle" data-toggle="dropdown" type="button"
														aria-expanded="false">
													...
													<ul class="dropdown-menu" role="menu">
														<li>
															<a class="js-delete-confirm" href="<?php echo e(route("admin.transaction.delete", $transaction->id)); ?>"><i
																	class="fa fa-trash"></i> Xóa</a>
														</li>
														<li class="divider"></li>
														<li>
															<a href="<?php echo e(route("admin.action.transaction", ["process", $transaction->id])); ?>"><i
																	class="fa fa-ban"></i>
																Đang bàn giao</a>
														</li>

														<li>
															<a href="<?php echo e(route("admin.action.transaction", ["success", $transaction->id])); ?>"><i
																	class="fa fa-ban"></i>
																Đã bàn giao</a>
														</li>
														<li>
															<a href="<?php echo e(route("admin.action.transaction", ["cancel", $transaction->id])); ?>"><i class="fa fa-ban"></i>
																Huỷ</a>
														</li>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button class="btn btn-primary" type="button">In đơn hàng</button>
				</div>
			</div>
			<!-- /.modal-content -->
		</div>
...
<?php echo $__env->make("layouts.app_master_admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/admin/transaction/index.blade.php ENDPATH**/ ?>