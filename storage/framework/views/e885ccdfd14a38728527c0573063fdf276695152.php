                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($slide->sd_active == 1): ?>
                                                    <a href="<?php echo e(route('admin.slide.active', $slide->id)); ?>" class="label label-info">Hiển hị</a>
                                                <?php else: ?> 
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\web_ban_giay_L9\resources\views/admin/slide/index.blade.php ENDPATH**/ ?>