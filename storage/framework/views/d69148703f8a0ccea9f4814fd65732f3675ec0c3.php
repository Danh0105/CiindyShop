<?php $__env->startSection("css"); ?>
	<link href="<?php echo e(asset("css/blog.min.css")); ?>" rel="stylesheet">
	<style type="text/css">
		.pagination {
			margin: 10px auto;
			display: flex;
				...
				<?php if(isset($articleTop)): ?>
					<div class="post-hot">
						<?php if($articleTop = $articlesHotTop->first()): ?>
							<div class="hot-left">
								<div class="avatar">
									<a class="image cover" href="<?php echo e(route("get.blog.detail", $articleTop->a_slug . "-" . $articleTop->id)); ?>"
										title="">
										<img class="lazyload" src="https://i.ytimg.com/vi/kBsUOeeSKXg/maxresdefault.jpg" alt="">
									</a>
								</div>
								<a class="title" href="" title=""><?php echo e($articleTop->a_name); ?></a>
						...
						<div class="hot-right">
							<?php $__currentLoopData = $articlesHotTop; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<?php if($i == 0): ?>
									<div class="top">
										<div class="avatar">
											<a class="image cover" href="<?php echo e(route("get.blog.detail", $item->a_slug . "-" . $item->id)); ?>" title="">
												<img class="lazyload" src="<?php echo e($item->a_avatar); ?>">
											</a>
										</div>
										<a class="title" href="<?php echo e(route("get.blog.detail", $item->a_slug . "-" . $item->id)); ?>"
											title=""><?php echo e($item->a_name); ?></a>
									</div>
								<?php else: ?>
									<div class="bot">
										<a class="" href="<?php echo e(route("get.blog.detail", $item->a_slug . "-" . $item->id)); ?>"
											title=""><?php echo e($item->a_name); ?></a>
									</div>
								<?php endif; ?>
...
<?php echo $__env->make("layouts.app_master_frontend", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/frontend/pages/article/index.blade.php ENDPATH**/ ?>