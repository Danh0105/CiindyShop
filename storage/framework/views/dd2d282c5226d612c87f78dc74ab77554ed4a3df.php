                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($menu->mn_status == 1): ?>
                                                    <a href="<?php echo e(route('admin.menu.active', $menu->id)); ?>" class="label label-info">Hiển thị</a>
                                                <?php else: ?> 
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?> 
                                                    <a href="<?php echo e(route('admin.menu.hot', $menu->id)); ?>" class="label label-default">Không có</a>
                                                <?php endif; ?>
                                            </td>
                                            <td><?php echo e($menu->created_at); ?></td>
                                            <td>
                                                <a href="<?php echo e(route('admin.menu.update', $menu->id)); ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i>Chỉnh sửa</a>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\THE CIINDYS\resources\views/admin/menu/index.blade.php ENDPATH**/ ?>