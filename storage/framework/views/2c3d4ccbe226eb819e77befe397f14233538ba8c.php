                    ...
                    <form role="form" action="" method="POST">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="form-group <?php echo e($errors->first('pdr_email') ? 'has-error' : ''); ?>">
                                <label for="pdr_name">Mail <span class="text-danger">(*)</span></label>
...
<?php echo $__env->make('layouts.app_master_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PHP_Laravel\THE CIINDYS\resources\views/admin/producer/update.blade.php ENDPATH**/ ?>