<?php $__env->startSection("content"); ?>
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo e(route("admin.attribute.index")); ?>"> Dữ liệu kích thước màu sắc sản phẩm</a></li>
		...
		<div class="box">
			<div class="box-header with-border">
				<div class="box-header">
					<h3 class="box-title"><a class="btn btn-primary" href="<?php echo e(route("admin.attribute.create")); ?>">Thêm mới <i
												...
												<div class="row">
													<div class="col-md-2">
														<a class="btn btn-xs"style="background-color: #3c8dbc;color: white;    margin: 5px 45px 5px 10px;"
															href="<?php echo e(route("admin.attribute.update", $attribute->id)); ?>"><i class="fa fa-pencil"></i>Chỉnh sữa</a>
													</div>
													<div class="col-md-2">
														<a class="btn btn-xs js-delete-confirm" href="<?php echo e(route("admin.attribute.delete", $attribute->id)); ?>"
...
<?php echo $__env->make("layouts.app_master_admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/admin/attribute/index.blade.php ENDPATH**/ ?>