		...
		<div class="box">
			<div class="box-header with-border">
				<div class="box-header">
					<h3 class="box-title"><a class="btn btn-primary" href="<?php echo e(route("admin.event.create")); ?>">Thêm mới <i
												...
												<div class="row">
													<div class="col-md-3">
														<a class="btn btn-xs"style="background-color: #3c8dbc;color: white;    margin: 5px 30px 5px 10px;"
															href="<?php echo e(route("admin.event.update", $event->id)); ?>"></i>Chỉnh sữa</a>
													</div>
													<div class="col-md-3">
														<a class="btn btn-xs js-delete-confirm" href="<?php echo e(route("admin.event.delete", $event->id)); ?>"
...
<?php echo $__env->make("layouts.app_master_admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\THE CIINDYS\THE CIINDYS\resources\views/admin/event/index.blade.php ENDPATH**/ ?>